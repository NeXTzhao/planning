...
class PiecewiseBezierFit2 {
 public:
  PiecewiseBezierFit2(const std::vector<Point> &points, int degree, double maxError);
 ...
 public:
  ...
  static std::vector<double> chordLengthParameterize(const std::vector<Point> &points);

  std::vector<Point> generateBezierControlPoint(const std::vector<Point> &points, const std::vector<double> &parameters, const Point &leftTangent, const Point &rightTangent);
  std::vector<std::vector<Point>> fitCubicBezier(const std::vector<Point> &points, const Point &leftTangent, const Point &rightTangent, double error);

  std::vector<double> reparameterize(const std::vector<Point> &bezier, const std::vector<Point> &points, const std::vector<double> &parameters);
  double newtonRaphsonRootFind(const std::vector<Point> &bez, const Point &point, double u);
  std::pair<double, int> computeMaxError(const std::vector<Point> &points, const std::vector<Point> &bez,
                                         const std::vector<double> &parameters);
  static double binomial_coefficient(int n, int k);
  std::vector<Point> bezier_curve(const std::vector<Point> &control_points, int num_points);
  void generate_bezier_curves(const std::vector<std::vector<Point>> &control_points_list, int num_points);
  ...
  std::vector<Point> generateBezierControlPoint(const std::vector<Point> &points, const std::vector<double> &parameters, const Point &leftTangent, const Point &rightTangent, double learning_rate = 0.01, int max_iterations = 1000);
};
