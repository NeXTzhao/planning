...
inline void backend(std::string const& name) { detail::s_backend = name; }
...
PyObject* get_array(std::vector<Numeric> const& v) {
...
template <typename Numeric>
PyObject* get_2darray(std::vector<::std::vector<Numeric>> const& v) {
...
inline PyObject* get_array(std::vector<std::string> const& strings) {
...
template <typename Numeric>
PyObject* get_listlist(std::vector<std::vector<Numeric>> const& ll) {
...
template <typename Numeric>
bool plot(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
...
#ifndef WITHOUT_NUMPY
template <typename Numeric>
void plot_surface(std::vector<::std::vector<Numeric>> const& x,
                  std::vector<::std::vector<Numeric>> const& y,
                  std::vector<::std::vector<Numeric>> const& z,
                  std::map<std::string, std::string> const& keywords =
                      std::map<std::string, std::string>(),
                  long const fig_number = 0) {
  detail::_interpreter::get();
...
template <typename Numeric>
void contour(std::vector<::std::vector<Numeric>> const& x,
             std::vector<::std::vector<Numeric>> const& y,
             std::vector<::std::vector<Numeric>> const& z,
             std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
template <typename Numeric>
void spy(std::vector<::std::vector<Numeric>> const& x,
         double const markersize = -1,  // -1 for default matplotlib size
         std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
template <typename Numeric>
void plot3(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
           std::vector<Numeric> const& z,
           std::map<std::string, std::string> const& keywords =
               std::map<std::string, std::string>(),
           long const fig_number = 0) {
  detail::_interpreter::get();
...
template <typename Numeric>
bool stem(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
          std::map<std::string, std::string> const& keywords) {
  assert(x.size() == y.size());
...
template <typename Numeric>
bool fill(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
          std::map<std::string, std::string> const& keywords) {
  assert(x.size() == y.size());
...
template <typename Numeric>
bool fill_between(std::vector<Numeric> const& x, std::vector<Numeric> const& y1,
                  std::vector<Numeric> const& y2,
                  std::map<std::string, std::string> const& keywords) {
...
bool arrow(Numeric x, Numeric y, Numeric end_x, Numeric end_y,
           std::string const& fc = "r", const std::string ec = "k",
...
template <typename Numeric>
bool hist(std::vector<Numeric> const& y, long bins = 10,
...
inline void imshow(void* ptr, const NPY_TYPES type, int const rows,
                   int const columns, int const colors,
                   std::map<std::string, std::string> const& keywords,
                   PyObject** out) {
...
inline void imshow(unsigned char const* ptr, int const rows, int const columns,
                   int const colors,
                   std::map<std::string, std::string> const& keywords = {},
...
inline void imshow(float const* ptr, int const rows, int const columns,
                   int const colors,
                   std::map<std::string, std::string> const& keywords = {},
                   PyObject** out = nullptr) {
...
#ifdef WITH_OPENCV
void imshow(cv::Mat const& image,
            std::map<std::string, std::string> const& keywords = {}) {
...
bool scatter(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
             double const s = 1.0,  // The marker size in points**2
             std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
bool scatter_colored(std::vector<NumericX> const& x,
                     std::vector<NumericY> const& y,
                     std::vector<NumericColors> const& colors,
                     double const s = 1.0,  // The marker size in points**2
                     std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
template <typename Numeric>
bool boxplot(std::vector<std::vector<Numeric>> const& data,
...
template <typename Numeric>
bool boxplot(std::vector<Numeric> const& data,
             std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
template <typename Numeric>
bool bar(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
...
template <typename Numeric>
bool bar(std::vector<Numeric> const& y, std::string ec = "black",
...
template <typename Numeric>
bool barh(std::vector<Numeric> const& x, std::vector<Numeric> const& y,
          std::string ec = "black", std::string ls = "-", double lw = 1.0,
          std::map<std::string, std::string> const& keywords = {}) {
  PyObject* xarray = detail::get_array(x);
  PyObject* yarray = detail::get_array(y);
...
inline bool subplots_adjust(
    std::map<std::string, double> const& keywords = {}) {
  detail::_interpreter::get();
...
template <typename Numeric>
bool named_hist(std::string label, std::vector<Numeric> const& y,
...
template <typename NumericX, typename NumericY>
bool plot(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
          std::string const& s = "") {
  assert(x.size() == y.size());
...
template <typename NumericX, typename NumericY, typename NumericZ>
bool contour(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
             std::vector<NumericZ> const& z,
             std::map<std::string, std::string> const& keywords = {}) {
...
template <typename NumericX, typename NumericY, typename NumericU,
          typename NumericW>
bool quiver(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
            std::vector<NumericU> const& u, std::vector<NumericW> const& w,
            std::map<std::string, std::string> const& keywords = {}) {
...
bool quiver(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
            std::vector<NumericZ> const& z, std::vector<NumericU> const& u,
            std::vector<NumericW> const& w, std::vector<NumericV> const& v,
            std::map<std::string, std::string> const& keywords = {}) {
...
template <typename NumericX, typename NumericY>
bool stem(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
          std::string const& s = "") {
  assert(x.size() == y.size());
...
template <typename NumericX, typename NumericY>
bool semilogx(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
              std::string const& s = "") {
  assert(x.size() == y.size());
...
template <typename NumericX, typename NumericY>
bool semilogy(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
              std::string const& s = "") {
  assert(x.size() == y.size());
...
template <typename NumericX, typename NumericY>
bool loglog(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
            std::string const& s = "") {
  assert(x.size() == y.size());
...
template <typename NumericX, typename NumericY>
bool errorbar(std::vector<NumericX> const& x, std::vector<NumericY> const& y,
              std::vector<NumericX> const& yerr,
              std::map<std::string, std::string> const& keywords = {}) {
  assert(x.size() == y.size());
...
template <typename Numeric>
bool named_plot(std::string const& name, std::vector<Numeric> const& y,
...
template <typename NumericX, typename NumericY>
bool named_plot(std::string const& name, std::vector<NumericX> const& x,
                std::vector<NumericY> const& y,
                std::string const& format = "") {
  detail::_interpreter::get();
...
template <typename NumericX, typename NumericY>
bool named_semilogx(std::string const& name, std::vector<NumericX> const& x,
                    std::vector<NumericY> const& y,
                    std::string const& format = "") {
  detail::_interpreter::get();
...
template <typename NumericX, typename NumericY>
bool named_semilogy(std::string const& name, std::vector<NumericX> const& x,
                    std::vector<NumericY> const& y,
                    std::string const& format = "") {
  detail::_interpreter::get();
...
template <typename NumericX, typename NumericY>
bool named_loglog(std::string const& name, std::vector<NumericX> const& x,
                  std::vector<NumericY> const& y,
                  std::string const& format = "") {
  detail::_interpreter::get();
...
template <typename Numeric>
bool plot(std::vector<Numeric> const& y, std::string const& format = "") {
...
template <typename Numeric>
bool plot(std::vector<Numeric> const& y,
          std::map<std::string, std::string> const& keywords) {
  std::vector<Numeric> x(y.size());
  for (size_t i = 0; i < x.size(); ++i) x.at(i) = i;
...
template <typename Numeric>
bool stem(std::vector<Numeric> const& y, std::string const& format = "") {
  std::vector<Numeric> x(y.size());
  for (size_t i = 0; i < x.size(); ++i) x.at(i) = i;
...
template <typename Numeric>
void text(Numeric x, Numeric y, std::string const& s = "") {
  detail::_interpreter::get();
...
inline void colorbar(PyObject* mappable = NULL,
                     std::map<std::string, float> const& keywords = {}) {
  if (mappable == NULL)
    throw std::runtime_error(
...
inline long figure(long number = -1) {
  ...
  long const figureNumber = PyLong_AsLong(num);
...
inline void legend(std::map<std::string, std::string> const& keywords) {
  detail::_interpreter::get();
...
template <typename Numeric>
inline void xticks(std::vector<Numeric> const& ticks,
                   std::vector<std::string> const& labels = {},
                   std::map<std::string, std::string> const& keywords = {}) {
...
template <typename Numeric>
inline void yticks(std::vector<Numeric> const& ticks,
                   std::vector<std::string> const& labels = {},
                   std::map<std::string, std::string> const& keywords = {}) {
  assert(labels.size() == 0 || ticks.size() == labels.size());
...
inline void tick_params(std::map<std::string, std::string> const& keywords,
...
inline void title(std::string const& titlestr,
                  std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
inline void suptitle(std::string const& suptitlestr,
                     std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
inline void axis(std::string const& axisstr) {
  detail::_interpreter::get();
...
inline void xlabel(std::string const& str,
                   std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
inline void ylabel(std::string const& str,
                   std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
...
inline void show(bool const block = true) {
  detail::_interpreter::get();
...
inline void save(std::string const& filename, int const dpi = 0) {
  detail::_interpreter::get();
...
inline void rcparams(std::map<std::string, std::string> const& keywords = {}) {
  detail::_interpreter::get();
  PyObject* args = PyTuple_New(0);
  PyObject* kwargs = PyDict_New();
  for (auto it = keywords.begin(); it != keywords.end(); ++it) {
...
struct plot_impl<std::false_type> {
  ...
  bool operator()(IterableX const& x, IterableY const& y,
                  std::string const& format) {
    detail::_interpreter::get();
...
struct plot_impl<std::true_type> {
  ...
  bool operator()(Iterable const& ticks, Callable const& f,
                  std::string const& format) {
...
bool plot(const A& a, const B& b, std::string const& format, Args... args) {
 ...
 */
inline bool plot(std::vector<double> const& x, std::vector<double> const& y,
                 std::string const& format = "") {
  return plot<double, double>(x, y, format);
}

inline bool plot(std::vector<double> const& y, std::string const& format = "") {
...
class Plot {
 public:
  ...
  template <typename Numeric>
  Plot(std::string const& name, std::vector<Numeric> const& x,
       std::vector<Numeric> const& y, std::string const& format = "") {
    detail::_interpreter::get();
  ...
  Plot(std::string const& name = "", std::string const& format = "")
      : Plot(name, std::vector<double>(), std::vector<double>(), format) {}

  template <typename Numeric>
  bool update(std::vector<Numeric> const& x, std::vector<Numeric> const& y) {
    assert(x.size() == y.size());
    if (set_data_fct) {
      PyObject* xarray = detail::get_array(x);
      PyObject* yarray = detail::get_array(y);
