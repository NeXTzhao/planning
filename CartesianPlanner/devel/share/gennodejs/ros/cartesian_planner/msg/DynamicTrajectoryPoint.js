...
class DynamicTrajectoryPoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DynamicTrajectoryPoint(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamicTrajectoryPoint(null);
...
module.exports = DynamicTrajectoryPoint;
