...
"""autogenerated by genpy from cartesian_planner/DynamicObstacles.msg. Do not edit."""
import codecs
import sys
...
class DynamicObstacles(genpy.Message):
  _md5sum = "30b207dd63b971b7a3a28ba13f187795"
  _type = "cartesian_planner/DynamicObstacles"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """DynamicObstacle[] obstacles
...
"""
  __slots__ = ['obstacles']
  _slot_types = ['cartesian_planner/DynamicObstacle[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cartesian_planner.msg.DynamicObstacle()
        _v2 = val1.polygon
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        val1.trajectory = []
        for i in range(0, length):
          val2 = cartesian_planner.msg.DynamicTrajectoryPoint()
          _x = val2
          start = end
          end += 32
