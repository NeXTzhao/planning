...
#include "hc00_reeds_shepp_state_space.hpp"
...
class HC00_Reeds_Shepp_State_Space::HC00_Reeds_Shepp {
 ...
 public:
  ...
  double TT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cstart = new HC_CC_Circle(c1.start, c1.left, c1.forward, CC_REGULAR,
  ...
  double TcTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cend = new HC_CC_Circle(c2);
    ...
    double length1 = (*cstart)->hc_turn_length(*qa) +
                     middle1->rs_turn_length(*qb) +
                     (*cend)->hc_turn_length(*qb);
    double length2 = (*cstart)->hc_turn_length(*qc) +
  ...
  double TTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cend = new HC_CC_Circle(c2);
    ...
    // select shortest connection
    double length1 = (*cstart)->cc_turn_length(*qa) +
                     middle1->hc_turn_length(*qb) +
                     (*cend)->hc_turn_length(*qb);
    double length2 = (*cstart)->cc_turn_length(*qc) +
  ...
  double TiST_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cend = new HC_CC_Circle(c2.start, c2.left, c2.forward, CC_REGULAR,
                             parent_->hc_cc_circle_param_);
    return (*cstart)->cc_turn_length(**q1) +
  ...
  bool TiSTcT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance >=
            sqrt(pow(2 * c1.radius * c1.sin_mu + 2 * fabs(c1.kappa_inv), 2) +
                 pow(2 * c1.radius * c1.cos_mu, 2)));
  }
  ...
  double TcTiST_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *ci = new HC_CC_Circle(**q2, !c1.left, c1.forward, true,
    ...
    return (*cstart)->hc_turn_length(**q1) + (*ci)->hc_turn_length(**q1) +
  ...
  bool TcTiSTcT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance >= sqrt(pow(2 * c1.radius, 2) +
                             16 * c1.radius * c1.sin_mu * fabs(c1.kappa_inv) +
                             pow(4 * c1.kappa_inv, 2)));
  }
  ...
  double TcTiSTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *ci2 = new HC_CC_Circle(**q3, !c2.left, c2.forward, true,
    ...
    return (*cstart)->hc_turn_length(**q1) + (*ci1)->hc_turn_length(**q1) +
  ...
  double TTcTT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cend = new HC_CC_Circle(c2.start, c2.left, c2.forward, CC_REGULAR,
    ...
    // select shortest connection
    double length1 =
        (*cstart)->cc_turn_length(*qa) + middle1->hc_turn_length(*qb) +
        middle2->hc_turn_length(*qb) + (*cend)->cc_turn_length(*qc);
    double length2 =
        (*cstart)->cc_turn_length(*qd) + middle3->hc_turn_length(*qe) +
  ...
  double TcTTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *cend = new HC_CC_Circle(c2);
    ...
    // select shortest connection
    double length1 =
        (*cstart)->hc_turn_length(*qa) + middle1->hc_turn_length(*qa) +
        middle2->hc_turn_length(*qc) + (*cend)->hc_turn_length(*qc);
    double length2 =
        (*cstart)->hc_turn_length(*qd) + middle3->hc_turn_length(*qd) +
  ...
  bool TciST_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return distance >= sqrt(pow(c1.radius * c1.sin_mu, 2) +
                            pow(c1.radius * c1.cos_mu + fabs(c1.kappa_inv), 2));
  }
  ...
  double TciST_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
                    ...
                    Configuration** q1, Configuration** q2) const {
    double alpha =
        asin((c1.radius * c1.cos_mu + fabs(c1.kappa_inv)) / distance);
    double delta_x1 = 0.0;
...
HC00_Reeds_Shepp_State_Space::HC00_Reeds_Shepp_State_Space(
    double kappa, double sigma, double discretization)
    : HC_CC_State_Space(kappa, sigma, discretization),
      hc00_reeds_shepp_{
          unique_ptr<HC00_Reeds_Shepp>(new HC00_Reeds_Shepp(this))} {
...
HC_CC_RS_Path* HC00_Reeds_Shepp_State_Space::hc00_circles_rs_path(
  ...
  if (hc00_reeds_shepp_->TcTT_exists(c1, c2)) {
    length[hc_cc_rs::TcTT] = hc00_reeds_shepp_->TcTT_path(
  ...
  if (hc00_reeds_shepp_->TTcT_exists(c1, c2)) {
    length[hc_cc_rs::TTcT] = hc00_reeds_shepp_->TTcT_path(
  ...
  if (hc00_reeds_shepp_->TST_exists(c1, c2)) {
    length[hc_cc_rs::TST] = hc00_reeds_shepp_->TST_path(
  ...
  if (hc00_reeds_shepp_->TSTcT_exists(c1, c2)) {
    length[hc_cc_rs::TSTcT] = hc00_reeds_shepp_->TSTcT_path(
  ...
  if (hc00_reeds_shepp_->TcTST_exists(c1, c2)) {
    length[hc_cc_rs::TcTST] = hc00_reeds_shepp_->TcTST_path(
  ...
  if (hc00_reeds_shepp_->TTT_exists(c1, c2)) {
    length[hc_cc_rs::TTT] = hc00_reeds_shepp_->TTT_path(
...
HC_CC_RS_Path* HC00_Reeds_Shepp_State_Space::hc00_reeds_shepp(
  ...
  start_circle[0] =
      new HC_CC_Circle(start, true, true, true, hc_cc_circle_param_);
  start_circle[1] =
      new HC_CC_Circle(start, false, true, true, hc_cc_circle_param_);
  start_circle[2] =
      new HC_CC_Circle(start, true, false, true, hc_cc_circle_param_);
  start_circle[3] =
      new HC_CC_Circle(start, false, false, true, hc_cc_circle_param_);
...
double HC00_Reeds_Shepp_State_Space::get_distance(State const& state1,
...
vector<Control> HC00_Reeds_Shepp_State_Space::get_controls(
    State const& state1, State const& state2) const {
