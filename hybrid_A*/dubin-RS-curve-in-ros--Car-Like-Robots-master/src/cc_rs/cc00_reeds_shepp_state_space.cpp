...
class CC00_Reeds_Shepp_State_Space::CC00_Reeds_Shepp {
 ...
 public:
  ...
  double TcTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    middle1 = new HC_CC_Circle(*qa, !c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle2 = new HC_CC_Circle(*qc, !c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);

    // select shortest connection
    double length1 = c1.cc_turn_length(*qa) + middle1->cc_turn_length(*qb) +
                     c2.cc_turn_length(*qb);
    double length2 = c1.cc_turn_length(*qc) + middle2->cc_turn_length(*qd) +
  ...
  bool TcTT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance <= 2 * c1.radius * (1 + c1.cos_mu)) &&
           (distance >= 2 * c1.radius * (1 - c1.cos_mu));
  }
  ...
  double TiST_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    return c1.cc_turn_length(**q1) + configuration_distance(**q1, **q2) +
  ...
  bool TiSTcT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance >=
            2 * c1.radius *
                sqrt(1 + 2 * c1.sin_mu * c1.cos_mu + pow(c1.cos_mu, 2)));
  }
  ...
  double TiSTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *ci = new HC_CC_Circle(**q2, !c1.left, c1.forward, c1.regular,
                           parent_->hc_cc_circle_param_);

    return c1.cc_turn_length(**q1) + configuration_distance(**q1, **q2) +
           (*ci)->cc_turn_length(**q3) + c2.cc_turn_length(**q3);
  }
  ...
  double TcTiST_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *ci = new HC_CC_Circle(**q1, !c1.left, !c1.forward, c1.regular,
                           parent_->hc_cc_circle_param_);

    return c1.cc_turn_length(**q1) + (*ci)->cc_turn_length(**q2) +
           configuration_distance(**q2, **q3) + c2.cc_turn_length(**q3);
  }
  ...
  bool TcTiSTcT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance >=
            2 * c1.radius *
                sqrt(1 + 4 * c1.cos_mu * c1.sin_mu + 4 * pow(c1.cos_mu, 2)));
  }
  ...
  double TcTiSTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    *ci1 = new HC_CC_Circle(**q1, !c1.left, !c1.forward, c1.regular,
                            parent_->hc_cc_circle_param_);
    *ci2 = new HC_CC_Circle(**q3, !c2.left, c2.forward, c2.regular,
                            parent_->hc_cc_circle_param_);

    return c1.cc_turn_length(**q1) + (*ci1)->cc_turn_length(**q2) +
           configuration_distance(**q2, **q3) + (*ci2)->cc_turn_length(**q4) +
           c2.cc_turn_length(**q4);
  }
  ...
  double TTcTT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    middle1 = new HC_CC_Circle(*qa, !c1.left, c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle2 = new HC_CC_Circle(*qb, !c2.left, !c2.forward, c2.regular,
                               parent_->hc_cc_circle_param_);
    middle3 = new HC_CC_Circle(*qd, !c1.left, c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle4 = new HC_CC_Circle(*qe, !c2.left, !c2.forward, c2.regular,
                               parent_->hc_cc_circle_param_);

    // select shortest connection
    double length1 = c1.cc_turn_length(*qa) + middle1->cc_turn_length(*qb) +
                     middle2->cc_turn_length(*qc) + c2.cc_turn_length(*qc);
    double length2 = c1.cc_turn_length(*qd) + middle3->cc_turn_length(*qe) +
                     middle4->cc_turn_length(*qf) + c2.cc_turn_length(*qf);
    if (length1 < length2) {
      *q1 = qa;
      *q2 = qb;
      *q3 = qc;
  ...
  bool TcTTcT_exists(HC_CC_Circle const& c1, HC_CC_Circle const& c2) const {
    ...
    return (distance <= 2 * c1.radius * (2 * c1.cos_mu + 1)) &&
           (distance >= 2 * c1.radius * (2 * c1.cos_mu - 1));
  }
  ...
  double TcTTcT_path(HC_CC_Circle const& c1, HC_CC_Circle const& c2,
    ...
    middle1 = new HC_CC_Circle(*qa, !c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle2 = new HC_CC_Circle(*qb, c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle3 = new HC_CC_Circle(*qd, !c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
    middle4 = new HC_CC_Circle(*qe, c1.left, !c1.forward, c1.regular,
                               parent_->hc_cc_circle_param_);
...
CC00_Reeds_Shepp_State_Space::CC00_Reeds_Shepp_State_Space(
    double kappa, double sigma, double discretization)
    : HC_CC_State_Space(kappa, sigma, discretization),
      cc00_reeds_shepp_{
          unique_ptr<CC00_Reeds_Shepp>(new CC00_Reeds_Shepp(this))} {}

CC00_Reeds_Shepp_State_Space::~CC00_Reeds_Shepp_State_Space() = default;

HC_CC_RS_Path* CC00_Reeds_Shepp_State_Space::cc00_circles_rs_path(
  ...
  if (cc00_reeds_shepp_->TT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TT] = cc00_reeds_shepp_->TT_path(
        *cstart[hc_cc_rs::TT], *cend[hc_cc_rs::TT], &qi1[hc_cc_rs::TT]);
  }
  // case TcT
  if (cc00_reeds_shepp_->TcT_exists(c1, c2)) {
    cstart[hc_cc_rs::TcT] = new HC_CC_Circle(c1);
    cend[hc_cc_rs::TcT] = new HC_CC_Circle(c2);
    length[hc_cc_rs::TcT] = cc00_reeds_shepp_->TcT_path(
        *cstart[hc_cc_rs::TcT], *cend[hc_cc_rs::TcT], &qi1[hc_cc_rs::TcT]);
  }
  // ##### Reeds-Shepp families: ############################################
  // case TcTcT
  if (cc00_reeds_shepp_->TcTcT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TcTcT] = cc00_reeds_shepp_->TcTcT_path(
        *cstart[hc_cc_rs::TcTcT], *cend[hc_cc_rs::TcTcT], &qi1[hc_cc_rs::TcTcT],
  ...
  if (cc00_reeds_shepp_->TcTT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TcTT] = cc00_reeds_shepp_->TcTT_path(
        *cstart[hc_cc_rs::TcTT], *cend[hc_cc_rs::TcTT], &qi1[hc_cc_rs::TcTT],
  ...
  if (cc00_reeds_shepp_->TTcT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TTcT] = cc00_reeds_shepp_->TTcT_path(
        *cstart[hc_cc_rs::TTcT], *cend[hc_cc_rs::TTcT], &qi1[hc_cc_rs::TTcT],
  ...
  if (cc00_reeds_shepp_->TST_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TST] = cc00_reeds_shepp_->TST_path(
        *cstart[hc_cc_rs::TST], *cend[hc_cc_rs::TST], &qi1[hc_cc_rs::TST],
        &qi2[hc_cc_rs::TST]);
  }
  // case TSTcT
  if (cc00_reeds_shepp_->TSTcT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TSTcT] = cc00_reeds_shepp_->TSTcT_path(
        *cstart[hc_cc_rs::TSTcT], *cend[hc_cc_rs::TSTcT], &qi1[hc_cc_rs::TSTcT],
  ...
  if (cc00_reeds_shepp_->TcTST_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TcTST] = cc00_reeds_shepp_->TcTST_path(
        *cstart[hc_cc_rs::TcTST], *cend[hc_cc_rs::TcTST], &qi1[hc_cc_rs::TcTST],
  ...
  if (cc00_reeds_shepp_->TTcTT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TTcTT] = cc00_reeds_shepp_->TTcTT_path(
        *cstart[hc_cc_rs::TTcTT], *cend[hc_cc_rs::TTcTT], &qi1[hc_cc_rs::TTcTT],
        &qi2[hc_cc_rs::TTcTT], &qi3[hc_cc_rs::TTcTT], &ci1[hc_cc_rs::TTcTT],
        &ci2[hc_cc_rs::TTcTT]);
  }
  // case TcTTcT
  ...
  if (cc00_reeds_shepp_->TTT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TTT] = cc00_reeds_shepp_->TTT_path(
        *cstart[hc_cc_rs::TTT], *cend[hc_cc_rs::TTT], &qi1[hc_cc_rs::TTT],
  ...
  if (cc00_reeds_shepp_->TcST_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TcST] = cc00_reeds_shepp_->TcST_path(
        *cstart[hc_cc_rs::TcST], *cend[hc_cc_rs::TcST], &qi1[hc_cc_rs::TcST],
        &qi2[hc_cc_rs::TcST]);
  }
  // case TScT
  if (cc00_reeds_shepp_->TScT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TScT] = cc00_reeds_shepp_->TScT_path(
        *cstart[hc_cc_rs::TScT], *cend[hc_cc_rs::TScT], &qi1[hc_cc_rs::TScT],
        &qi2[hc_cc_rs::TScT]);
  }
  // case TcScT
  if (cc00_reeds_shepp_->TcScT_exists(c1, c2)) {
    ...
    length[hc_cc_rs::TcScT] = cc00_reeds_shepp_->TcScT_path(
        *cstart[hc_cc_rs::TcScT], *cend[hc_cc_rs::TcScT], &qi1[hc_cc_rs::TcScT],
        &qi2[hc_cc_rs::TcScT]);
  }
label_end:
...
HC_CC_RS_Path* CC00_Reeds_Shepp_State_Space::cc00_reeds_shepp(
  ...
  start_circle[0] =
      new HC_CC_Circle(start, true, true, CC_REGULAR, hc_cc_circle_param_);
  start_circle[1] =
      new HC_CC_Circle(start, false, true, CC_REGULAR, hc_cc_circle_param_);
  start_circle[2] =
      new HC_CC_Circle(start, true, false, CC_REGULAR, hc_cc_circle_param_);
  start_circle[3] =
      new HC_CC_Circle(start, false, false, CC_REGULAR, hc_cc_circle_param_);
  end_circle[0] =
      new HC_CC_Circle(end, true, true, CC_REGULAR, hc_cc_circle_param_);
  end_circle[1] =
      new HC_CC_Circle(end, false, true, CC_REGULAR, hc_cc_circle_param_);
  end_circle[2] =
      new HC_CC_Circle(end, true, false, CC_REGULAR, hc_cc_circle_param_);
  end_circle[3] =
      new HC_CC_Circle(end, false, false, CC_REGULAR, hc_cc_circle_param_);
...
double CC00_Reeds_Shepp_State_Space::get_distance(State const& state1,
...
vector<Control> CC00_Reeds_Shepp_State_Space::get_controls(
    State const& state1, State const& state2) const {
