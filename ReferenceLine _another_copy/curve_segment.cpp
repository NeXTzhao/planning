...
CurveSegment::CurveSegment(double theta0, double kappa0, double dkappa0,
                           double x0, double y0, double theta1, double kappa1,
                           double dkappa1, double x1, double y1, double delta)
    : theta0_(theta0),
      kappa0_(kappa0),
      dkappa0_(dkappa0),
      x0_(x0),
