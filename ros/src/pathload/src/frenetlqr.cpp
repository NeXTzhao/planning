...
int main(int argc, char **argv) {
  ...
  frenet_lqr = a.advertise<geometry_msgs::Twist>("/smart/cmd_vel", 20);
  ...
  /**************************************************************/
  // 发布规划轨迹
  path_pub = a.advertise<nav_msgs::Path>("rvizpath", 20, true);
  ...
  /**************************************************************/
  //发布小车运动轨迹
  trajectory_path = a.advertise<nav_msgs::Path>("trajectorypath", 20, true);
