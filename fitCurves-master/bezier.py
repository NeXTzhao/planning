...
# evaluates quadratic bezier at t, return point
# def q(ctrlPoly, t):
#     return (1.0 - t) ** 2 * ctrlPoly[0] + 2 * (1.0 - t) * t * ctrlPoly[1] + t ** 2 * ctrlPoly[2]
#
#
# # evaluates quadratic bezier first derivative at t, return point
# def qprime(ctrlPoly, t):
#     return 2 * (1.0 - t) * (ctrlPoly[1] - ctrlPoly[0]) + 2 * t * (ctrlPoly[2] - ctrlPoly[1])
#
#
# # evaluates quadratic bezier second derivative at t, return point
# def qprimeprime(ctrlPoly, t):
