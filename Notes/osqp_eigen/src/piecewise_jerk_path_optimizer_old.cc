/*
 * @Author: wangdezhao
 * @Date: 2022-04-12 17:48:05
 * @LastEditTime: 2022-04-13 17:45:02
...
void PiecewiseJerkPathOptimizer::Process(
    /* const SpeedData& speed_data, */ /* const ReferenceLine& reference_line,
                                        */
    const points::PathPoint& init_point,
    /* const common::TrajectoryPoint& init_point, */ /* const bool
                                                        path_reusable, */
    /*  PathData* const final_path_data */ const points::PathPoint&
        end_points) {
  ...
  //     ADEBUG << "for s[" << static_cast<double>(i) *
...
bool PiecewiseJerkPathOptimizer::OptimizePath(
  ...
  PiecewiseJerkPathProblem piecewise_jerk_problem(100, 0.1, x_init);
  ...
  //       pull_over_type == PullOverStatus::EMERGENCY_PULL_OVER ? 200.0
  //       : 10.0;
...
int main() {
  points::PathPoint& init_point(1);
  points::PathPoint& end_point(500);
