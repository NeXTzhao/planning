/*
 * @Author: wangdezhao
 * @Date: 2022-05-01 22:58:21
 * @LastEditTime: 2022-05-02 00:16:43
 * @FilePath: /osqp_eigen/common/math/cartesian_frenet_conversion/include/cartesian_frenet_conversion.h
 * @Copyright:  
 */
...
/*
车辆运动描述:
  cartesian坐标系下为： x,y,theta_x,kappa_x,v,a (theta为航向角、kappa为曲率)
  frenet坐标系下为：s,l,s_dot,s_ddot,l',l'' 
  下表x表示车辆，下表r表示参考点，dot表示对时间求导，’表示对自变量求导
*/
class CartesianFrenetConverter {
 public:
   ...
   */
  /*
    * 将笛卡尔坐标系中的车辆状态转换为 Frenet 坐标系。
    * 将 2d 运动解耦为两个独立的 1d 运动 w.r.t. 参考线。
    * 横向移动是纵向累积距离 s 的函数，以更好地满足非完整约束。
  */
