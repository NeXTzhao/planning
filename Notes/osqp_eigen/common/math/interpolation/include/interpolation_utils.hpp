 ...
 * @LastEditTime: 2022-04-08 17:43:06
 * @FilePath: /osqp_eigen/common/math/interpolation/include/interpolation/interpolation_utils.hpp
 * @Copyright:  
 */
...
inline void validateInput(const std::vector<double>& base_keys,
  ...
  // when query_keys is out of base_keys (This function does not allow exterior
  // division.)
  if (query_keys.front() < base_keys.front() ||
      base_keys.back() < query_keys.back()) {
