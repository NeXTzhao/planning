...
class LaneSectionMap : private std::multimap<double, LaneSection>,
...
public:
  ...
  LaneSection &GetById(SectionId id) { return *_by_id.at(id); }

  const LaneSection &GetById(SectionId id) const { return *_by_id.at(id); }
