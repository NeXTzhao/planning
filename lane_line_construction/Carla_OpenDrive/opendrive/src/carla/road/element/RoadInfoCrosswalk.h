...
public:
  RoadInfoCrosswalk(const double s, const std::string name, const double t,
      ...
      : RoadInfo(s), _name(name), _t(t), _zOffset(zOffset), _hdg(hdg),
        _pitch(pitch), _roll(roll), _orientation(orientation), _width(width),
        _length(length), _points(points) {}
