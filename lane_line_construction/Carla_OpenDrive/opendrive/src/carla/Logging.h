...
LIBCARLA_NOINLINE static void write_to_stream(std::ostream &out, Arg &&arg,
                                              Args &&... args) {
...
template <typename... Args> static inline void log(Args &&... args) {
...
template <typename... Args> static inline void log_debug(Args &&...) {}
...
template <typename... Args> static inline void log_info(Args &&...) {}
...
template <typename... Args> static inline void log_warning(Args &&...) {}
...
template <typename... Args> static inline void log_error(Args &&...) {}
...
template <typename... Args> static inline void log_critical(Args &&...) {}
