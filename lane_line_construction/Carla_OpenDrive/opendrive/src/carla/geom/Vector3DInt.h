...
public:
  ...
  Vector3DInt(int32_t ix, int32_t iy, int32_t iz) : x(ix), y(iy), z(iz) {}

  // =========================================================================
  // -- Other methods --------------------------------------------------------
  // =========================================================================

  int64_t SquaredLength() const { return x * x + y * y + z * z; }
  ...
  bool operator!=(const Vector3DInt &rhs) const { return !(*this == rhs); }
  ...
  Vector3DInt ToMeters() const { return *this / 100; }

  /// Return a Vector3DInt converted from meters to centimeters.
  Vector3DInt ToCentimeters() const { return *this * 100; }

  FIntVector ToFIntVector() const { return FIntVector{x, y, z}; }
