...
/// and end iterators.
template <typename IT> class ListView {
public:
  using iterator = IT;
  ...
  explicit ListView(iterator begin, iterator end) : _begin(begin), _end(end) {
...
template <typename Container> static inline auto MakeListView(Container &c) {
