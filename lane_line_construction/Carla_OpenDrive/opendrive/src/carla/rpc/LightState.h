...
public:
  ...
  LightState(geom::Location location, float intensity, LightGroup group,
             Color color, bool active)
      : _location(location), _intensity(intensity),
        _group(static_cast<flag_type>(group)), _color(color), _active(active) {}
