...
WeightedLaneKey::WeightedLaneKey(std::string road_id, double lanesection_s0,
    ...
    : LaneKey(std::move(road_id), lanesection_s0, lane_id), weight(weight) {}
...
std::vector<LaneKey>
RoutingGraph::get_lane_successors(const LaneKey &lane_key) const {
...
std::vector<LaneKey>
RoutingGraph::get_lane_predecessors(const LaneKey &lane_key) const {
  std::unordered_set<WeightedLaneKey> res =
