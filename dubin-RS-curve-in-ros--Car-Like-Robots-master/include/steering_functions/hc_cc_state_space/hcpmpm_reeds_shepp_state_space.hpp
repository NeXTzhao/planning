...
/** \brief
    ...
    (p) or negative (n) max. curvature at the start and goal configuration
    as described in: H. Banzhaf et al., "Hybrid Curvature Steer: A Novel
    Extend Function for Sampling-Based Nonholonomic Motion Planning in Tight
    Environments," IEEE International Conference on Intelligent Transportation
    Systems (Oct. 2017).
    ...
    */
class HCpmpm_Reeds_Shepp_State_Space : public HC_CC_State_Space
{
public:
  /** \brief Constructor */
